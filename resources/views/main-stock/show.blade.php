            ...
            <div class="card-body">
                @if($mainStock->item->image_path)
                    <div class="text-center mb-3">
                        <img src="{{ asset('media/' . $mainStock->item->image_path) }}" alt="{{ $mainStock->item->item_name }}" class="img-fluid rounded border shadow-sm" style="max-height: 180px; object-fit: contain;">
                    </div>
                @else
